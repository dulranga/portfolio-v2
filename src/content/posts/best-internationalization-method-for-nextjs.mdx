...
4. Create helper files inside `src/lib` folder
...
5. Setup middleware.ts for locale detection
...
6. Create i18n provider for Client Components
...
7. Create a custom hook for translations in Client Components
...
8. Update your root layout to setup i18n
    ...
    ```
9. Extract and compile messages
...
10. Simple component to change locale
